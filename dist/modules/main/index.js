        ...
        constructor(parent, options) {
            ...
            this.onSetupPage = async (connected, hideLoading) => {
                ...
                try {
                    ...
                    if (this.firstTokenObject && this.firstTokenObject.symbol !== ((_b = store_2.ChainNativeTokenByChainId[store_2.getChainId()]) === null || _b === void 0 ? void 0 : _b.symbol)) {
            ...
            this.getFirstAvailableBalance = () => {
                ...
                let commissionsAmount = this.data.commissionFee && this.data.commissionFeeTo ? tokenBalance.times(this.data.commissionFee) : new eth_wallet_1.BigNumber(0);
                const maxTokenBalance = tokenBalance.gt(commissionsAmount) ? tokenBalance.minus(commissionsAmount) : new eth_wallet_1.BigNumber(0);
            ...
            this.getSecondAvailableBalance = () => {
                ...
                return eth_wallet_1.Utils.fromDecimals(amount, ((_a = this.secondTokenObject) === null || _a === void 0 ? void 0 : _a.decimals) || 18).toFixed();
            };
            ...
            this.firstInputChange = () => {
                ...
                const inputVal = new eth_wallet_1.BigNumber(this.firstInput.value).times(restrictedPrice);
                if (inputVal.isNaN()) {
                    ...
                    this.lbOrderTotal.caption = `${global_1.formatNumber(totalAmount, 6)} ${symbol}`;
                }
            ...
            this.onSubmit = async () => {
                ...
                this.showResultMessage(this.otcQueueAlert, 'warning', `Selling ${global_1.formatNumber(this.firstInput.value)} ${(firstToken === null || firstToken === void 0 ? void 0 : firstToken.symbol) || ''} to ${global_1.formatNumber(this.secondInput.value)} ${(secondToken === null || secondToken === void 0 ? void 0 : secondToken.symbol) || ''}`);
                const params = {
            ...
            this.renderOTCQueueCampaign = async () => {
                ...
                if (this.otcQueueInfo) {
                    ...
                    const lbTimer = await components_2.Label.create({ caption: 'Starts In', font: { size: '16px' } });
                    ...
                    const lbEndTime = await components_2.Label.create({ caption: 'Ended On', font: { size: '16px' } });
                    lbEndTime.classList.add('opacity-50');
                    hStackEndTime.appendChild(lbEndTime);
                    hStackEndTime.appendChild(this.$render("i-label", { caption: global_1.formatDate(expire), font: { size: '16px', bold: true }, lineHeight: "29px" }));
                    let interval;
                    const setTimer = () => {
                        let days = 0;
                        let hours = 0;
                    ...
                    this.otcQueueElm.appendChild(this.$render("i-panel", { class: "pnl-ofc-queue container", padding: { bottom: 15, top: 15, right: 20, left: 20 }, height: "auto" },
                        this.$render("i-hstack", { horizontalAlignment: "center" },
                            this.$render("i-vstack", { gap: 10, width: 215, margin: { right: 20 }, padding: { right: 20 }, border: { right: { width: 1.5, style: 'solid', color: '#04081D' } }, position: "relative", verticalAlignment: "center" },
                                ...
                                logo ? this.$render("i-image", { width: 80, height: 80, margin: { left: 'auto', right: 'auto' }, url: logo, fallbackUrl: store_2.fallBackUrl }) : [],
                            ...
                            this.$render("i-vstack", { verticalAlignment: "center" },
                                this.$render("i-vstack", { gap: 4, verticalAlignment: "center" },
                                    this.$render("i-label", { caption: "Offer to Buy", font: { size: '12px' }, class: "opacity-50" }),
                                    this.$render("i-hstack", { gap: 4, verticalAlignment: "end" },
                                        this.$render("i-label", { caption: `${global_1.formatNumber(restrictedPrice)} ${((_b = this.secondTokenObject) === null || _b === void 0 ? void 0 : _b.symbol) || ''}`, font: { size: '24px', name: 'Montserrat Bold' } }),
                                        this.$render("i-label", { caption: `~ ${global_1.formatNumber(usd)} USD`, font: { size: '12px' }, lineHeight: "22px", class: "opacity-50" }))),
                                this.$render("i-hstack", { gap: 50, margin: { top: 15 }, verticalAlignment: "start" },
                                    this.$render("i-vstack", { gap: 4, width: "calc(50% - 25px)" },
                                        this.$render("i-label", { caption: "Offer Availability", font: { size: '12px' }, class: "opacity-50" }),
                                        this.$render("i-hstack", { gap: 4, verticalAlignment: "end" },
                                            this.$render("i-label", { caption: `${global_1.formatNumber(availableAmount)} ${((_c = this.firstTokenObject) === null || _c === void 0 ? void 0 : _c.symbol) || ''}`, font: { size: '24px', name: 'Montserrat Bold' } }))),
                                    this.$render("i-vstack", { gap: 4 },
                                        this.$render("i-label", { caption: "Valid Period", font: { size: '12px' }, class: "opacity-50" }),
                                        hStackTimer,
                                        hStackEndTime)),
                                this.$render("i-hstack", { gap: 10, margin: { top: 15 }, verticalAlignment: "center" },
                                    this.$render("i-vstack", { gap: 4, width: "calc(50% - 20px)", height: 85, verticalAlignment: "center" },
                                        this.$render("i-hstack", { gap: 4, verticalAlignment: "end" },
                                            ...
                                            this.$render("i-label", { caption: `Balance: ${global_1.formatNumber(this.getFirstAvailableBalance())} ${firstSymbol}`, font: { size: '12px' }, tooltip: { content: `${global_1.formatNumber(this.getFirstAvailableBalance())} ${firstSymbol}`, placement: 'top' }, class: "opacity-50 text-overflow", maxWidth: "calc(100% - 110px)", margin: { left: 'auto' } }),
                                ...
                                this.$render("i-hstack", { visible: isCommissionVisible, gap: 10, verticalAlignment: "center", horizontalAlignment: "space-between" },
                                    this.$render("i-label", { caption: "Commission Fee", font: { size: '14px' }, class: "opacity-50" }),
                                    this.$render("i-label", { id: "lbCommissionFee", caption: `0 ${((_h = this.firstTokenObject) === null || _h === void 0 ? void 0 : _h.symbol) || ''}`, font: { size: '14px' } })),
                                this.$render("i-hstack", { gap: 10, verticalAlignment: "center", horizontalAlignment: "space-between" },
                                    this.$render("i-label", { caption: orderTotalCaption, font: { size: '14px' }, class: "opacity-50" }),
                                    this.$render("i-label", { id: "lbOrderTotal", caption: `0 ${((_j = this.firstTokenObject) === null || _j === void 0 ? void 0 : _j.symbol) || ''}`, font: { size: '14px' } })),
            ...
            if (options && options.proxyAddresses) {
                store_2.setProxyAddresses(options.proxyAddresses);
            }
