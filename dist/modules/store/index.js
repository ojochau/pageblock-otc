...
define("@modules/store", ["require", "exports", "@ijstech/components", "@ijstech/eth-wallet", "@scom/oswap-openswap-contract", "@modules/global", "@modules/assets", "@modules/store/data/index.ts", "@modules/store/data/index.ts"], function (require, exports, components_1, eth_wallet_1, oswap_openswap_contract_1, global_1, assets_1, index_7, index_8) {
    ...
    const setDataFromSCConfig = (networkList, infuraId, proxyInfo) => {
        if (proxyInfo) {
            exports.setProxyAddresses(proxyInfo);
        }
        if (infuraId) {
